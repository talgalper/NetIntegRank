...
NetIntegRank is a modular Nextflow pipeline for identifying dysregulated subnetworks from differential expression data and prioritising candidate targets by integrating network topology, structural druggability, and optional auxiliary features.
...
For users who just want to run the pipeline once the dependencies are installed:
